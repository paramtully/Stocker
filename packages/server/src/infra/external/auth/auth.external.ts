import { UserRole } from "packages/domain/src/user/index";
...
export default interface AuthExternalService {
    ...
    // Methods for updating Cognito user attributes
    updateUserEmail(cognitoUsername: string, email: string): Promise<void>;
